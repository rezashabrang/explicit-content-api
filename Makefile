...
check-codestyle:
	...
	poetry run darglint --verbosity 2 explicit_content_api tests
...
.PHONY: complexity
complexity:
	poetry run radon cc explicit_content_api --total-average

.PHONY: interrogate
interrogate:
	poetry run interrogate -v explicit_content_api

.PHONY: maintainability
maintainability:
	poetry run radon mi explicit_content_api
